# Brick Breaker by Tech With Tim
# download PyScripter
...
pygame.display.set_caption("Brick Breaker by Tech With Tim")

FPS = 60
yellow_rect_right = pygame.Rect(WIDTH - WIDTH/3, 0, WIDTH/3, HEIGHT)
yellow_rect_left = pygame.Rect(0, 0, WIDTH/3, HEIGHT)
...
def draw(win, paddle, ball, bricks, lives):
    win.fill("White")
    # pygame.draw.rect(win, Yellow, yellow_rect_left)
    # pygame.draw.rect(win, Green, yellow_rect_right)
    paddle.draw(win)
    ball.draw(win)
